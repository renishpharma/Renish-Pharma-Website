            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                ...
                <p className="text-lg text-surface-dark/50 font-medium leading-relaxed pt-1">
                  With our years of experience in this industry and dedicated teamwork as a family, we deal in a general range of pharmaceutical products, including <span className="font-bold bg-brand-primary text-white px-1">third party manufacturing and monopoly</span> rights services. We deploy the best skilled and experienced workforce for R&D, quality management, production, packaging, and logistics.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-8">
              <p className="text-xl text-surface-dark/70 font-medium leading-relaxed">
                Renish Pharmaceutical is recognized as the <span className="font-bold text-brand-primary">Top PCD pharma franchise in India</span>, offering a wide range of generic pharma products with <span className="font-bold text-brand-primary">monopoly rights</span> and specialized <span className="font-bold text-brand-primary">third party manufacturing</span> services. We are dedicated to delivering professionalism in every dose.
              </p>
              <p className="text-xl text-surface-dark/70 font-medium leading-relaxed">
                As a leading <span className="font-bold text-brand-primary">generic pharma company</span> based in Chandigarh, Panchkula, and Himachal, we provide unparalleled business opportunities for pharma professionals through our robust franchise model and global quality standards.
              </p>
