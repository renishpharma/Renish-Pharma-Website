  ...
  return (
    <section className="py-24 bg-white border-t border-primary-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div 
          className="relative overflow-hidden -mx-6 px-6"
        ...
        >
          <motion.div 
            ...
            animate={{
              x: isPaused ? undefined : [0, -((featuredProducts.length * 320) + (featuredProducts.length * 32))],
            }}
            transition={{
              duration: featuredProducts.length * 5,
              ease: "linear",
              repeat: Infinity,
            }}
          >
            {/* We duplicate the items to create the infinite effect */}
                  ...
                  <div className="bg-surface-light rounded-4xl p-6 border border-surface-light hover:border-brand-primary/20 transition-all shadow-card hover:shadow-premium h-full flex flex-col relative overflow-hidden">
                    ...
                    <div className="pt-4 border-t border-primary-50 grid grid-cols-2 gap-4 mt-auto">
                       ...
                       <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-bold text-surface-dark truncate" title={product.packagingType || product.packaging || "N/A"}>
                            {product.packagingType || product.packaging || "Pack N/A"}
                          </span>
                       </div>
                    </div>
